...
Subtracts the finite field 𝔽₂ⁿ from the Polynomial representation of the Collatz map. The **Error Map** ($A \oplus B$) visualizes the entropy generated by non linear carry propagation. See the code in `modules/comparator.py` for more information about the implementation details.
